...
constexpr uint8_t stairs[] PROGMEM
{
 ...
 // Frame 0
	...
	// Frame 0
	0x00, 0xCE, 0xCE, 0xCE, 0xCE, 0xCE, 0xCE, 0xCE, 0xCE, 0xCE, 0xCE, 0x00,
	0x00, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x00,
	
	// Frame 0
	0xFE, 0xFE, 0x00, 0x00, 0xFE, 0xFE, 0x00, 0x00, 0xFE, 0xFE, 0xFE, 0x00,
	0x07, 0x07, 0x00, 0x00, 0x07, 0x07, 0x00, 0x00, 0x07, 0x07, 0x07, 0x00,
	
	// Frame 0
	0x00, 0xFE, 0xFE, 0xFE, 0x00, 0x00, 0xFE, 0xFE, 0x00, 0x00, 0xFE, 0xFE,
	0x00, 0x07, 0x07, 0x07, 0x00, 0x00, 0x07, 0x07, 0x00, 0x00, 0x07, 0x07,
};
...
constexpr uint8_t exitBlock[] PROGMEM
{
  ...
  // Frame 0
  0x01, 0xFF, 0xFF, 0x01, 0x07, 0x09, 0x09, 0x07, 0x01, 0xFF, 0xFF, 0x01,
	0x08, 0x0F, 0x0F, 0x08, 0x00, 0x00, 0x00, 0x00, 0x08, 0x0F, 0x0F, 0x08,
};
...
constexpr uint8_t startScreen[] PROGMEM
{
	// Width, Height
	8, 8,
	
	// Frame 0
	0x00, 0xC3, 0xFF, 0xB9, 0x9D, 0xFF, 0xC3, 0x00,
	
	// Frame 0
	0x7E, 0x66, 0x2C, 0x3C, 0x3C, 0x34, 0x66, 0x7E,
	
	// Frame 0
	0x00, 0x00, 0x60, 0x78, 0x4C, 0x54, 0x66, 0x7E,
	
	// Frame 0
	0x7E, 0x66, 0x54, 0x4C, 0x78, 0x60, 0x00, 0x00,

	0x00, 0x00, 0x03, 0x0F, 0x19, 0x15, 0x33, 0x3F,
	
	// Frame 0
	0x3F, 0x33, 0x15, 0x19, 0x0F, 0x03, 0x00, 0x00,
};

constexpr uint8_t gfx[] PROGMEM
{
	// Width, Height
	8, 8,
  ...
  // Frame 0
	...
	// Frame 0
	0x45, 0x51, 0x15, 0x54, 0x45, 0x51, 0x15, 0x54,
	
	
};

constexpr uint8_t settingsIcon[] PROGMEM
{
	// Width, Height
	8, 8,
	
	// Frame 1
	0x42, 0xA2, 0x42, 0x42, 0x42, 0x42, 0x45, 0x42,
	
	// Frame 1
	0x42, 0x45, 0x42, 0x42, 0x42, 0x42, 0xA2, 0x42,
};
...
constexpr uint8_t difficultyIcon[] PROGMEM
{
	// Width, Height
	8, 8,
	
	// Frame 0
	0x7E, 0xDF, 0xBB, 0xBF, 0xBF, 0xBB, 0xDF, 0x7E,
	
	// Frame 0
	0x7E, 0xFF, 0xDB, 0xDF, 0xDF, 0xDB, 0xFF, 0x7E,
	
	// Frame 0
	0x7E, 0xB5, 0x9B, 0x95, 0x95, 0x9B, 0xB5, 0x7E,
};


const int MAX_NUMBER_OF_ITEMS_IN_HOUSE = 38;
const int RIGHT = 0;
const int LEFT = 1;
const int UP = 2;
const int DOWN = 3;
